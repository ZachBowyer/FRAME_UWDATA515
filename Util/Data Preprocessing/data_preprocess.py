"""
This code reads in two datasets: KingCounty Inspection data and
UberEats restaurant data, filters them based on zip code, and performs a fuzzy
match algorithm using the address column to merge the two datasets.
...
intended for use in a dashboard.
"""
